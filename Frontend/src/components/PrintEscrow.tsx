  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 print:hidden">
      <div className="bg-white rounded-2xl max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl print:max-w-none print:shadow-none">
        ...
        {/* Blockchain */}
        {escrow.escrow_hash || escrow.blockchain_tx_hash && (
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {escrow.escrow_hash && (
                <div>
                  ...
                  <p className="text-sm font-mono bg-gray-900 text-gray-100 p-4 rounded-lg break-all print:text-base print:p-6">{escrow.escrow_hash}</p>
                </div>
              )}
        ...
        <div className="p-8 print:p-12 border-t border-gray-200 bg-gray-50 text-xs text-gray-500 text-center print:text-sm">
          <p>{t('pages.print_footer_info', 'This document was digitally generated by SafeDeal Escrow Platform. All terms are protected by hybrid blockchain audit logs. EscrowHash: {{hash}} Tx: {{tx}}'.replace('{{hash}}', escrow.escrow_hash || 'N/A').replace('{{tx}}', escrow.blockchain_tx_hash || 'N/A'))}</p>
