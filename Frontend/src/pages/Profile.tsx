                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-sm font-medium ${
                      ...
                      {user.activated ? 'Account Verified' : 'Account Pending Verification'}
                    </span>
                  </div>
                </div>
              </motion.div>
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-yellow-700 mt-1">
                            ...
                            SafeDeal will never ask for your private key.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              >
                ...
                <form onSubmit={handleSubmit(handleUpdateBankDetails)} className="space-y-6">
                  ...
                  <div>
                      ...
                      />
                    {errors.bank_code && (
                      <p className="text-red-500 text-sm mt-1">{errors.bank_code.message}</p>
                    )}
                  </div>
                ...
                <div className="card p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between py-2">
                      ...
                      <span className="text-sm font-medium">Today at 2:30 PM</span>
                    </div>
                    <div className="flex items-center justify-between py-2">
